...
static const char *fonts[]          = { "LiberationMono:size=8", "Noto Color Emoji:size=8" };
static const char dmenufont[]       = "LiberationMono:size=8";
...
static const Key keys[] = {
	...
	{ ControlMask,            XF86XK_AudioMute,          spawn,           SHCMD("wpctl set-mute @DEFAULT_SOURCE@ toggle; kill -35 $(pidof dwmblocks)") },
	{      0,                 XF86XK_AudioLowerVolume,   spawn,           SHCMD("wpctl set-volume @DEFAULT_SINK@ 5%-; kill -36 $(pidof dwmblocks)") },
	{ ShiftMask,              XF86XK_AudioLowerVolume,   spawn,           SHCMD("wpctl set-volume @DEFAULT_SINK@ 1%-; kill -36 $(pidof dwmblocks)") },
	{ ControlMask,            XF86XK_AudioLowerVolume,   spawn,           SHCMD("wpctl set-volume @DEFAULT_SOURCE@ 5%-; kill -35 $(pidof dwmblocks)") },
	{ ControlMask|ShiftMask,  XF86XK_AudioLowerVolume,   spawn,           SHCMD("wpctl set-volume @DEFAULT_SOURCE@ 1%-; kill -35 $(pidof dwmblocks)") },
	{      0,                 XF86XK_AudioRaiseVolume,   spawn,           SHCMD("wpctl set-volume @DEFAULT_SINK@ 5%+; kill -36 $(pidof dwmblocks)") },
	{ ShiftMask,              XF86XK_AudioRaiseVolume,   spawn,           SHCMD("wpctl set-volume @DEFAULT_SINK@ 1%+; kill -36 $(pidof dwmblocks)") },
	{ ControlMask,            XF86XK_AudioRaiseVolume,   spawn,           SHCMD("wpctl set-volume @DEFAULT_SOURCE@ 5%+; kill -35 $(pidof dwmblocks)") },
	{ ControlMask|ShiftMask,  XF86XK_AudioRaiseVolume,   spawn,           SHCMD("wpctl set-volume @DEFAULT_SOURCE@ 1%+; kill -35 $(pidof dwmblocks)") },
	{      0,                 XF86XK_MonBrightnessDown,  spawn,           SHCMD("$HOME/coding/scripts/dwm_brightness -13") },
	{ ShiftMask,              XF86XK_MonBrightnessDown,  spawn,           SHCMD("$HOME/coding/scripts/dwm_brightness -3") },
	{      0,                 XF86XK_MonBrightnessUp,    spawn,           SHCMD("$HOME/coding/scripts/dwm_brightness 13") },
	{ ShiftMask,              XF86XK_MonBrightnessUp,    spawn,           SHCMD("$HOME/coding/scripts/dwm_brightness 3") },
	...
	{ MODKEY|ControlMask,     XK_p,                      spawn,           SHCMD("prismlauncher") },
